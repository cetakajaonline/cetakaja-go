<script lang="ts">
  ...
  export let reportData: MonthlyReportData;
</script>

<!-- Top Selling Products Section -->
{#if reportData.topSellingProducts && reportData.topSellingProducts.length > 0}
  <div class="mb-6">
    <h3 class="text-xl font-bold m-6 text-center">Produk Terlaris Bulanan</h3>
...
<div>
  <h3 class="text-xl font-bold m-6 text-center">Rincian Pendapatan Bulanan</h3>
  ...
  {:else}
    <div class="alert alert-info">
      <div>
        <span>Tidak ada pesanan pada bulan ini.</span>
      </div>
    </div>
  {/if}
</div>
...
<div class="mt-6">
  <h3 class="text-xl font-bold m-6 text-center">Rincian Pengeluaran Bulanan</h3>
  ...
  {:else}
    <div class="alert alert-info">
      <div>
        <span>Tidak ada pengeluaran pada bulan ini.</span>
      </div>
    </div>
  {/if}
</div>