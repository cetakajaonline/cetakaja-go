...
{#if reportData.topSellingProducts && reportData.topSellingProducts.length > 0}
  <div class="mb-6">
    <h3 class="text-xl font-bold m-6 text-center">Produk Terlaris Tahunan</h3>
...
<div>
  <h3 class="text-xl font-bold m-6 text-center">Rincian Pendapatan Tahunan</h3>
  ...
  {:else}
    <div class="alert alert-info">
      <div>
        <span>Tidak ada pesanan pada tahun ini.</span>
      </div>
    </div>
  {/if}
</div>
...
<div class="mt-6">
  <h3 class="text-xl font-bold m-6 text-center">Rincian Pengeluaran Tahunan</h3>
  ...
  {:else}
    <div class="alert alert-info">
      <div>
        <span>Tidak ada pengeluaran pada tahun ini.</span>
      </div>
    </div>
  {/if}
</div>