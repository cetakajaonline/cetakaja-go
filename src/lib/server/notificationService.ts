...
export async function createPaymentNotification(order: Order, user: User, paymentStatus: string) {
  let message = '';
...
export async function updateNotificationStatus(id: number, status: 'sent' | 'failed') {
