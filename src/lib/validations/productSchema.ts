...
export const productSchema = z.object({
  name: z
    ...
    .max(150, "Nama produk terlalu panjang (maksimal 150 karakter)"),
  description: z
    .string()
  ...
  baseCode: z
    ...
    .max(50, "Kode produk terlalu panjang (maksimal 50 karakter)"),
  photo: z
    .string()
    .max(255, "URL foto terlalu panjang (maksimal 255 karakter)")
    .optional(),
