...
export const POST: RequestHandler = async ({ request, url, locals }) => {
  try {
    ...
    switch (format) {
      case "pdf":
        content = `Exported ${report.reportType} report from ${report.dateRange.start.toISOString()} to ${report.dateRange.end.toISOString()}`;
      ...
      case "xlsx":
        ...
        break;
      case "csv":
        content = `Report Type,Start Date,End Date,Total,Revenue,Expenses,Net\\n${report.reportType},${report.dateRange.start.toISOString()},${report.dateRange.end.toISOString()},${report.summary.total},${report.summary.revenue},${report.summary.expenses},${report.summary.net}`;
