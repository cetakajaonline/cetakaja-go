<script lang="ts">
  ...
  import ExpenseReportChart from "$lib/components/reports/ExpenseReportChart.svelte";
  import ExpenseReportSummary from "$lib/components/reports/ExpenseReportSummary.svelte";
...
<DefaultLayout title="Expense Report">
  ...
  <PageHeader title="Laporan Pengeluaran" icon="💸" />
