<script lang="ts">
  ...
  function addOrderItem() {
    ...
    formData.orderItems = [...formData.orderItems, item];
  ...
  async function handleSubmit(e: Event) {
    ...
    if (formData.orderItems.length === 0) {
      error = "Silakan tambahkan setidaknya satu item pesanan";
      return;
    }
    ...
    try {
      ...
      error = (err as Error).message || "Gagal membuat order";
    } finally {
      loading = false;
    }
  }
...
<div class="p-6">
  <div class="mb-6">
    ...
    <p class="text-gray-600">Tambahkan pesanan pelanggan baru</p>
  </div>
